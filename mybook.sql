...
(1, '追风筝的人', '[美]卡勒德·胡赛尼', '上海人民出版社', '2006-5', '29.00', '9787208061644', '12岁的阿富汗富家少爷阿米尔与仆人哈桑情同手足。然而在一场风筝比赛后，发生了一件悲惨不堪的事，阿米尔为自己的懦弱感到自责和痛苦，逼走了哈桑，不久，自己也跟随父亲逃往美国。'),
...
(5, 10001, '2020-05-18', '2022-02-18'),
(36, 10012, '2019-05-23', '2019-07-23'),
(66, 10001, '2020-05-18', '2020-09-18'),
(74, 10002, '2020-02-13', '2020-04-13'),
(87, 10002, '2020-03-26', '2020-05-26'),
(98, 10002, '2020-04-13', '2020-06-13'),
(99, 10012, '2019-05-23', '2019-07-23'),
(135, 10000, '2020-01-09', '2020-03-09'),
(156, 10002, '2020-03-21', '2020-05-21'),
(166, 10003, '2020-02-24', '2020-04-24'),
(177, 10003, '2020-01-28', '2020-03-28'),
(205, 10003, '2020-04-15', '2020-06-15'),
(218, 10000, '2020-02-12', '2020-04-12'),
(233, 10003, '2020-04-02', '2020-06-02');
...
CREATE TABLE `user` (
  ...
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0 is report the loss,1 is normal',
  `admin` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0 is user,1 is admin',
...
INSERT INTO `user` (`id`, `pwd`, `name`, `class`, `mobile`, `qq`, `email`, `postcode`, `address`, `status`, `admin`, `last_login_time`) VALUES
(10000, 'e10adc3949ba59abbe56e057f20f883e', 'PengWengui', 'GG', '13198536865', 6, '1320334244@qq.com', 666, '广西科技大学东环校区268号北区宿舍4-406', 1, 0, '2020-05-19 00:47:34'),
(10001, '20917c851c4a54f2a054390dac9085b7', 'Zhong Zhaoning', 'GXUST', '13356', 33, 'sasa2', 66563, '11', 1, 0, '2020-05-19 00:13:51'),
(10002, 'e10adc3949ba59abbe56e057f20f883e', 'Lu Zekun', 'GXUST', '', 0, '', 0, '', 1, 0, '2020-05-19 00:45:59'),
(10003, '8d70d8ab2768f232ebe874175065ead3', 'Shi Yiming', 'GXUST', '', 0, '', 0, '', 1, 0, '2020-04-13 21:34:21'),
(10011, 'e10adc3949ba59abbe56e057f20f883e', 'Huang Zhifen', 'Liuzhou Library', '', 0, '', 0, '', 1, 1, '2020-04-21 04:17:29'),
(10012, 'e10adc3949ba59abbe56e057f20f883e', 'Chen Bo', 'GXUST', '', 0, '', 0, '', 0, 0, '2019-06-20 07:19:17'),
(10086, '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'Admin', '', 0, '', 0, '', 1, 1, '2020-05-18 23:52:30');
